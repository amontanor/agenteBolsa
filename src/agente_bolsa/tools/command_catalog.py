...
def available_command_catalog() -> list[dict[str, Any]]:
    ...
    return [
        ...
        {
            "group": "aprendizaje",
            "command": r".\.venv\Scripts\python.exe -m agente_bolsa.main learning-daily-run",
            "description": "Ejecuta el ledger incremental diario: deduplicacion, digest, salud y candidatos de politica.",
        },
        {
            "group": "aprendizaje",
            "command": r".\.venv\Scripts\python.exe -m agente_bolsa.main learning-health",
            "description": "Mide por que no esta aprendiendo: duplicados, cobertura de outcomes, ejecucion real y latencia.",
        },
        {
            "group": "aprendizaje",
            "command": r".\.venv\Scripts\python.exe -m agente_bolsa.main learning-digest",
            "description": "Imprime el digest determinista que se inyecta en la siguiente decision LLM.",
        },
        {
            "group": "aprendizaje",
            "command": r".\.venv\Scripts\python.exe -m agente_bolsa.main policy-candidates",
            "description": "Lista reglas shadow, guarded-active y activas con su evidencia.",
        },
        {
            "group": "aprendizaje",
            "command": r".\.venv\Scripts\python.exe -m agente_bolsa.main learning-promotions",
            "description": "Audita promociones y reversiones del motor de aprendizaje.",
        },
        {
            "group": "estado",
            "command": r".\.venv\Scripts\python.exe -m agente_bolsa.main operational-health",
            "description": "Combina salud de jobs, cobertura de datos y deterioro reciente por setup en un unico informe.",
        },
        {
            "group": "estado",
            "command": r".\.venv\Scripts\python.exe -m agente_bolsa.main operational-responses",
        ...
        {
            "group": "aprendizaje",
            "command": r".\.venv\Scripts\python.exe -m agente_bolsa.main learning-postmortem --from 2026-04-27",
            "description": "Reconstruye cohortes de senales, explicaciones, fallos contrafactuales y duplicados ejecutados.",
        },
        {
            "group": "aprendizaje",
            "command": r".\.venv\Scripts\python.exe -m agente_bolsa.main missed-opportunities --from 2026-04-27",
            "description": "Lista oportunidades perdidas detectables y las separa por filtro, ranking o timing.",
        },
        {
            "group": "aprendizaje",
            "command": r".\.venv\Scripts\python.exe -m agente_bolsa.main decision-compare --from 2026-04-27 --policy proposed",
            "description": "Compara politica actual vs nueva sin fuga temporal, con el mismo stream historico.",
        },
        {
            "group": "aprendizaje",
            "command": r".\.venv\Scripts\python.exe -m agente_bolsa.main walk-forward-validate --from 2026-04-27 --policy proposed",
            "description": "Valida la politica propuesta en ventanas train/test cronologicas fuera de muestra.",
        },
        {
            "group": "aprendizaje",
            "command": r".\.venv\Scripts\python.exe -m agente_bolsa.main session-retrospective --sessions 8",
            "description": "Resume por sesion cerrada que habria pasado con la politica nueva frente a la actual.",
        },
        {
            "group": "aprendizaje",
        ...
        {
            "group": "analisis",
            "command": r".\.venv\Scripts\python.exe -m agente_bolsa.main pre-earnings --days 5",
            "description": "Apartado informativo: acciones con earnings after close por dia, hipotesis, resultado si ya existe y % de exito. No compra.",
        },
        {
            "group": "analisis",
            "command": r".\.venv\Scripts\python.exe -m agente_bolsa.main pre-earnings-backtest --from 2024-01-01 --universe AAPL,MSFT,NVDA --max-symbols 3",
            "description": "Event-study historico informativo de las hipotesis pre-earnings AMC. No compra.",
        },
        {
            "group": "scheduler",
            "command": r".\.venv\Scripts\python.exe -m agente_bolsa.main job-once pre-earnings --force",
            "description": "Fuerza el estudio pre-earnings informativo aunque aun no sea la hora configurada.",
        },
        {
            "group": "analisis",
...
def command_cheatsheet() -> str:
    ...
    return "\n".join(
        [
            ...
            r"   .\.venv\Scripts\python.exe -m agente_bolsa.main learning-postmortem --from 2026-04-27",
            r"   .\.venv\Scripts\python.exe -m agente_bolsa.main decision-compare --from 2026-04-27 --policy proposed",
            r"   .\.venv\Scripts\python.exe -m agente_bolsa.main session-retrospective --sessions 8",
            r"   .\.venv\Scripts\python.exe -m agente_bolsa.main adaptive-tune",
            r"   .\.venv\Scripts\python.exe -m agente_bolsa.main adaptive-status",
            "   Crea memoria operativa, compara old vs new y propone cambios conservadores; no toca .env.",
            "",
            "8) Ver log resumido",
            ...
            "",
            "14) Ver pre-earnings informativo",
            r"   .\.venv\Scripts\python.exe -m agente_bolsa.main pre-earnings --days 5",
            "   Lista acciones por sesion AMC, hipotesis, resultado si ya esta publicado y % de exito. No compra.",
            r"   .\.venv\Scripts\python.exe -m agente_bolsa.main job-once pre-earnings --force",
            "   Fuerza el mismo estudio desde el scheduler para comprobar la automatizacion diaria.",
            "",
            "15) Event-study pre-earnings",
            r"   .\.venv\Scripts\python.exe -m agente_bolsa.main pre-earnings-backtest --from 2024-01-01 --universe AAPL,MSFT,NVDA --max-symbols 3",
            "   Mide historicamente aciertos y retornos de las hipotesis pre-earnings. No compra.",
            "",
            ...
            "",
            "20) Ver contexto de rebalanceo sin LLM",
            ...
            "",
            "21) Ejecutar planes aprobados en Alpaca paper",
            ...
            "",
            "22) Ver catalogo completo en JSON",
