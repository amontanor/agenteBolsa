...
class Settings(BaseSettings):
    ...
    max_daily_buy_orders: int = Field(default=2, alias="MAX_DAILY_BUY_ORDERS")
    ...
    closed_market_study_universe: str = Field(
        default="sp500_top300",
        alias="CLOSED_MARKET_STUDY_UNIVERSE",
    )
    closed_market_study_max_symbols: int = Field(default=300, alias="CLOSED_MARKET_STUDY_MAX_SYMBOLS")
    intraday_technical_scan_enabled: bool = Field(default=True, alias="INTRADAY_TECHNICAL_SCAN_ENABLED")
    intraday_technical_scan_universe: str = Field(default="", alias="INTRADAY_TECHNICAL_SCAN_UNIVERSE")
